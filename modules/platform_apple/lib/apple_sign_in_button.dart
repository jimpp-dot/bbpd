...
class AppleSignInIcon extends StatelessWidget {
  /// The callback that is called when the button is tapped or otherwise activated.
  ///
  /// A type for the authorization button.
  final ButtonType type;
  ...
  @override
  Widget build(BuildContext context) {
    final bgColor = style == ButtonStyle.black ? Colors.black : Colors.white;
    final textColor = style == ButtonStyle.black ? Colors.white : Colors.black;
    final borderColor =
        style == ButtonStyle.white ? Colors.white : Colors.black;
      ...
      child: Center(
        child: Row(
          ...
          children: <Widget>[
            Padding(
              padding:
                  const EdgeInsetsDirectional.only(bottom: 1, start: 2, end: 6),
              child: SizedBox(
                height: 20,
                child: AspectRatio(
                  aspectRatio: 25 / 31,
