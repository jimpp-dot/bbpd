...
class AppleSignIn {
  ...
  static const EventChannel _eventChannel =
      EventChannel('dev.gilder.tom/apple_sign_in_events');
  ...
  static Stream<void> get onCredentialRevoked {
    return _onCredentialRevoked ??= _eventChannel.receiveBroadcastStream();
  }
  ...
  static Future<CredentialState> getCredentialState(String userId) async {
    ...
    switch (credentialState) {
      ...
      case 'revoked':
        return const CredentialState(status: CredentialStatus.revoked);

      case 'authorized':
        return const CredentialState(status: CredentialStatus.authorized);

      case 'notFound':
        return const CredentialState(status: CredentialStatus.notFound);

      case 'transferred':
        return const CredentialState(status: CredentialStatus.transferred);
    }
