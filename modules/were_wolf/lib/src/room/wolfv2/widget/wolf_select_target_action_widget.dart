...
import 'package:were_wolf/src/room/wolfv2/widget/wolf_select_target_user_widget.dart';
import 'package:were_wolf/src/room/wolfv2/widget/wolf_user_icon.dart';

///选择目标行动框
class WolfSelectTargetActionWidget extends StatelessWidget {
  ...
  const WolfSelectTargetActionWidget({
    super.key,
      ...
      res.add(
        Row(
          ...
          children: actionPositions!
              .map((_) => WolfSelectTargetUserWidget(
                    roomPosition: _,
                    opFlag: opFlag,
                  ))
              .toList(),
