...
class PoliceVoteWidget extends StatelessWidget {
  final ChatRoomData room;

  const PoliceVoteWidget({super.key, required this.room});
      ...
      children: <Widget>[
        Positioned(
          ...
          child: WolfSelectTargetActionWidget(
            actionTitle: K.wolf_v2_vote_action_desc_police,
            ...
            onButtonTap: () async {
              if (targetPosition != null) {
                ...
                if (cuid > 0) {
                  bool op = await model.policeVote(
