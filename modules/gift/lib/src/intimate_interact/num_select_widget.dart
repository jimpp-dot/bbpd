...
class NumSelectWidget extends StatefulWidget {
  ...
  const NumSelectWidget(this.data, this.selectCount, this.offset, {super.key});

  @override
  _NumSelectWidgetState createState() => _NumSelectWidgetState();
  static Future<int?> show(
    ...
    return showDialog<int>(
        ...
        builder: (buildContext) {
          return NumSelectWidget(data, selectCount, offset);
        });
  }
}
