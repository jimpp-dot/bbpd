...
class CpLinkDiyRelationWidget extends StatefulWidget {
  final ChatRoomData room;
  final CplinkMessage? data;

  const CpLinkDiyRelationWidget({super.key, required this.room, this.data});

  @override
  State<StatefulWidget> createState() => CpLinkDiyRelationState();
}

class CpLinkDiyRelationState extends State<CpLinkDiyRelationWidget>
  ...
  @override
  void didUpdateWidget(covariant CpLinkDiyRelationWidget oldWidget) {
  ...
  void _diffRefresh() {
    ...
    List<AuctionRelationTotalProgressItem> list = widget.data!.progress.list;
    if (index == -1) {
