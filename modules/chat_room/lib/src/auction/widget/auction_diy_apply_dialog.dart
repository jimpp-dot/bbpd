...
class AuctionDiyApplyDialog extends StatefulWidget {
  final AuctionDefendDiyEmitMessage data;

  const AuctionDiyApplyDialog({super.key, required this.data});

  @override
  State<StatefulWidget> createState() => AuctionDiyApplyState();
  ...
  static Future show(BuildContext context,
    ...
    return showDialog(
      ...
      builder: (context) => AuctionDiyApplyDialog(data: data),
    );
  }
}

class AuctionDiyApplyState extends State<AuctionDiyApplyDialog> {
  int _second = 10;
  ...
  void _onTap(int agree) async {
    NormalNull res = await AuctionRepo.replayDiyRelation(
        rid: widget.data.rid,
        agree: agree,
