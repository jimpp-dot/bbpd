...
import 'package:chat_room/src/talent_new/data/talent_add_user_mixin_new.dart';
...
/// 添加主播页面
class TalentAddUserPanelNew extends StatefulWidget {
  const TalentAddUserPanelNew({super.key});

  @override
  _TalentAddUserPanelNewState createState() => _TalentAddUserPanelNewState();
    ...
    return showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return TalentHelperNew.blurDialogWidget(
          child: const TalentAddUserPanelNew(),
        );
      },
    );
  }
...
class _TalentAddUserPanelNewState extends State<TalentAddUserPanelNew>
    with TalentAddSearchDataNewMixin<TalentAddUserPanelNew> {
  Timer? _cancelTimer;
