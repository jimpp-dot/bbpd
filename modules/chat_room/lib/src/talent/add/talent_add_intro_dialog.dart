...
// 编辑节目信息输入框
class TalentAddIntroDialog extends StatefulWidget {
  final String? text;

  const TalentAddIntroDialog({super.key, this.text});
...
class _TalentAddIntroDialogState extends State<TalentAddIntroDialog> {
