...
import '../imageStretch/renderImageStretch.dart';
import 'package:flutter/rendering.dart';

class RawImageStretch extends LeafRenderObjectWidget {
  /// Creates a widget that displays an image.
  ///
  /// The [scale], [alignment], [repeat], [matchTextDirection] and [filterQuality] arguments must
  /// not be null.
  const RawImageStretch({
    super.key,
    this.image,
    this.width,
    this.height,
  ...
  @override
  RenderImageStretch createRenderObject(BuildContext context) {
    assert((!matchTextDirection && alignment is Alignment) ||
        debugCheckHasDirectionality(context));
    return RenderImageStretch(
      image: image,
      width: width,
      height: height,
      scale: scale,
  ...
  void updateRenderObject(
      BuildContext context, RenderImageStretch renderObject) {
    renderObject
      ..image = image
      ..width = width
      ..height = height
