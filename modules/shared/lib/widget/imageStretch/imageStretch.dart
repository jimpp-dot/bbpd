...
import '../imageStretch/rawImageStretch.dart';

class ImageStretch extends StatefulWidget {
  ...
  ImageStretch.asset(
    ...
    this.alignment = Alignment.center,
    this.repeat = ImageRepeat.noRepeat,
    required this.centerSlice, //只使用了left top
    this.matchTextDirection = false,
    this.gaplessPlayback = false,
    String? package,
    this.filterQuality = FilterQuality.low,
  ...
  @override
  _ImageStretchState createState() => _ImageStretchState();
...
class _ImageStretchState extends State<ImageStretch>
  ...
  late DisposableBuildContext<State<ImageStretch>> _scrollAwareContext;
  ...
  void initState() {
    ...
    _scrollAwareContext = DisposableBuildContext<State<ImageStretch>>(this);
  }
  ...
  @override
  void didUpdateWidget(ImageStretch oldWidget) {
