...
class PreloadTabBarView extends StatefulWidget {
  /// Creates a page view with one child per tab.
  ///
  /// The length of [children] must be the same as the [controller]'s length.
  const PreloadTabBarView({
    super.key,
...
class _TabBarViewState extends State<PreloadTabBarView> {
  ...
  void didChangeDependencies() {
    ...
    _pageController = PageController(
        ...
        viewportFraction: widget.isPreload ? 0.9999 : 1.0);
  }

  @override
  void didUpdateWidget(PreloadTabBarView oldWidget) {
