...
import 'lan.pbenum.dart';

export 'lan.pbenum.dart';
...
class Languages extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..m<$core.String, $core.String>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'texts',
        entryClassName: 'Languages.TextsEntry',
        keyFieldType: $pb.PbFieldType.OS,
        valueFieldType: $pb.PbFieldType.OS,
        packageName: const $pb.PackageName('pb'))
    ..m<$core.String, ListValue>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'array',
        entryClassName: 'Languages.ArrayEntry',
        keyFieldType: $pb.PbFieldType.OS,
  ...
  Languages._() : super();
  factory Languages({
    $core.Map<$core.String, $core.String>? texts,
    $core.Map<$core.String, ListValue>? array,
  }) {
  ...
  factory Languages.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory Languages.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  Languages copyWith(void Function(Languages) updates) =>
      super.copyWith((message) => updates(message as Languages))
          as Languages; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static Languages getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<Languages>(create);
  static Languages? _defaultInstance;

  @$pb.TagNumber(1)
  $core.Map<$core.String, $core.String> get texts => $_getMap(0);

  @$pb.TagNumber(2)
  $core.Map<$core.String, ListValue> get array => $_getMap(1);
}
