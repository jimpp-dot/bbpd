...
final class MethodCallHandlerImpl implements MethodCallHandler {
  ...
  public void onMethodCall(MethodCall call, Result result) {
    ...
    final String pkg = call.argument("package");
    switch (call.method) {
      case "canLaunch":
      ...
      case "closeWebView":
        ...
        break;
      case "canLaunchAndroid":
        onCanLaunchAndroid(result, pkg);
        break;
      case "launchAndroid":
        onLaunchAndroid(result, pkg);
        break;
      default:
  ...
  private void onCanLaunchAndroid(Result result, String pkg) {
    result.success(urlLauncher.canLaunchAndroid(pkg));
  }

  private void onLaunchAndroid(Result result, String pkg) {
    LaunchStatus launchStatus = urlLauncher.launchAndroid(pkg);
