  ...
  void performLayout() {
    ...
    if (firstChild != null) {
      ...
      final int trailingGarbage =
          _calculateTrailingGarbage(targetLastIndex ?? 0);
    ...
    for (int index = indexOf(trailingChildWithLayout!) + 1;
      ...
      assert(childParentData.index == index);
      childParentData.layoutOffset =
          indexToLayoutOffset(itemExtent, childParentData.index ?? 0);
    }
    ...
    callViewportBuilder(
      ...
      exposureRatioThreshold: extendedListDelegate.exposureRatioThreshold,
    );
