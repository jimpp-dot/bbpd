  ...
  void performLayout() {
    ...
    if (firstChild != null && lastChild != null) {
      ...
      final int leadingGarbage =
          (firstIndex - oldFirstIndex).clamp(0, childCount).toInt();
      final int trailingGarbage = targetLastIndex == null
          ? 0
          : (oldLastIndex - targetLastIndex).clamp(0, childCount).toInt();
    ...
    switch (lastChildLayoutType) {
      ...
      case LastChildLayoutType.foot:
        ...
        trailingScrollOffset = data.index == 0
            ? size
            : layout
                .getGeometryForChildIndex((data.index ?? 0) - 1)
                .trailingScrollOffset;
        ...
        trailingScrollOffset = (data.layoutOffset ?? 0) + size;
    ...
    if (extendedListDelegate.viewportBuilder != null) {
      ...
      callViewportBuilder(
          ...
          getPaintExtend: (RenderBox child) {
            ...
            final SliverGridGeometry gridGeometry =
                layout.getGeometryForChildIndex(childParentData.index ?? 0);
