...
/// [ListView.new] constructor's `children` argument corresponds to the
...
class ExtendedListView extends BoxScrollView {
  ...
  /// [ExtendedListView] itself is created, it is more efficient to use [ListView.new].
...
///
/// The [GridView.new], [ExtendedGridView.count], and [ExtendedGridView.extent]
