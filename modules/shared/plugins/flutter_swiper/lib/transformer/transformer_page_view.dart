...
typedef ValueCallback = void Function(double value);
...
class TransformerPageView extends StatefulWidget {
  ...
  final ValueCallback? onScrollUpdate;
...
class _TransformerPageViewState extends State<TransformerPageView> {
  ...
  double _calcCurrentPixels() {
    ...
    //  Log.d("activeIndex:$_activeIndex , pix:$_currentPixels");
        ...
        onNotification: (ScrollNotification notification) {
          if (notification is ScrollStartNotification) {
            ...
            if (widget.onScrollEnd != null) {
              // Log.d("Swiper11 onScrollEnd");
              widget.onScrollEnd!();
            }
          } else if (notification is ScrollUpdateNotification) {
            if (widget.onScrollUpdate != null) {
              widget.onScrollUpdate!.call(notification.scrollDelta ?? 0);
            }
          }
