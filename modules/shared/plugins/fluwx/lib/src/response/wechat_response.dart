...
typedef _WeChatResponseInvoker = BaseWeChatResponse Function(Map argument);
...
class WeChatAuthResponse extends BaseWeChatResponse {
  ...
  @override
  bool operator ==(other) {
    return other is WeChatAuthResponse && code == other.code && country == other.country && lang == other.lang && state == other.state;
  }
