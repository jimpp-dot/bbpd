...
/// 海龟汤-得分榜
class RankPuzzleScoreLoader extends StatefulWidget {
  final PageConfig? config;

  const RankPuzzleScoreLoader({super.key, this.config});

  @override
  _RankPuzzleScoreLoaderState createState() => _RankPuzzleScoreLoaderState();
}

class _RankPuzzleScoreLoaderState extends State<RankPuzzleScoreLoader>
    with AutomaticKeepAliveClientMixin<RankPuzzleScoreLoader> {
  ...
  _load() async {
    try {
      XhrResponse response = await Xhr.postJson(
          "${System.domain}games/puzzle/scoreRank",
          {
            'type': widget.type,
          },
          throwOnError: true,
