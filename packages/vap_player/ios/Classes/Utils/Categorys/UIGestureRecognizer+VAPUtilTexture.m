...
@interface _CommonVAPUIGestureRecognizerBlockTarget : NSObject
...
@implementation _CommonVAPUIGestureRecognizerBlockTarget
...
@implementation UIGestureRecognizer (VAPUtilTexture)
...
- (void)addVapActionBlock:(void (^)(id sender))block {
    ...
    _CommonVAPUIGestureRecognizerBlockTarget *target = [[_CommonVAPUIGestureRecognizerBlockTarget alloc] initWithBlock:block];
...
- (NSMutableArray *)_vap_allUIGestureRecognizerBlockTargets {
    ...
    if (!targets) {
        targets = [CommonQGVAPSafeMutableArray new];
