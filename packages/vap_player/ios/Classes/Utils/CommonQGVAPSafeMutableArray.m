...
@interface CommonQGVAPSafeMutableArray (){
...
@implementation CommonQGVAPSafeMutableArray
...
- (BOOL)isEqualToArray:(NSArray *)otherArray {
    ...
    if ([otherArray isKindOfClass:CommonQGVAPSafeMutableArray.class]) {
        CommonQGVAPSafeMutableArray *other = (id)otherArray;
        BOOL isEqual;
        [_lock lock];
        [other->_lock lock];
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:[CommonQGVAPSafeMutableArray class]]) {
        CommonQGVAPSafeMutableArray *other = object;
        BOOL isEqual;
        [_lock lock];
        [other->_lock lock];
