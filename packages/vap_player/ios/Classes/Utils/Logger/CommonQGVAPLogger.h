...
#define VAP_Logger(level, module, format, ...) if(common_external_VAP_Logger)common_external_VAP_Logger(level, __FILE__, __LINE__, __FUNCTION__, module, format, ##__VA_ARGS__); else common_internal_VAP_Logger_handler(level, __FILE__, __LINE__, __FUNCTION__, module, format, ##__VA_ARGS__);
...
typedef void (*CommonQGVAPLoggerFunc)(VAPLogLevel, const char*, int, const char*, NSString *, NSString *, ...);

#if defined __cplusplus
extern "C" {
#endif
    
    extern CommonQGVAPLoggerFunc common_external_VAP_Logger;
    void common_internal_VAP_Logger_handler(VAPLogLevel level, const char* file, int line, const char* func, NSString *module, NSString *format, ...);
    
#if defined __cplusplus
};
#endif

@interface CommonQGVAPLogger : NSObject

+ (void)registerExternalLog:(CommonQGVAPLoggerFunc)externalLog;
