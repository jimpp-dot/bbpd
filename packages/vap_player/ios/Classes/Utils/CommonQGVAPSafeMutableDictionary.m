...
#import "CommonQGVAPSafeMutableDictionary.h"
...
@interface CommonQGVAPSafeMutableDictionary(){
...
@implementation CommonQGVAPSafeMutableDictionary
...
- (BOOL)isEqualToDictionary:(NSDictionary *)otherDictionary {
    ...
    if ([otherDictionary isKindOfClass:CommonQGVAPSafeMutableDictionary.class]) {
        CommonQGVAPSafeMutableDictionary *other = (id)otherDictionary;
        BOOL isEqual;
        [_lock lock];
        [other->_lock lock];
...
- (BOOL)isEqual:(id)object {
    ...
    if ([object isKindOfClass:CommonQGVAPSafeMutableDictionary.class]) {
        CommonQGVAPSafeMutableDictionary *other = object;
        BOOL isEqual;
        [_lock lock];
        [other->_lock lock];
        isEqual = [_dic isEqual:other->_dic];
