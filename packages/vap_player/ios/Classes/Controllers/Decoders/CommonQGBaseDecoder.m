...
NSString* kCQGVAPDecoderSeekStart = @"kCQGVAPDecoderSeekStart";
NSString* kCQGVAPDecoderSeekFinish = @"kCQGVAPDecoderSeekFinish";

@interface CommonQGBaseDecoder() {

    CommonQGBaseDFileInfo *_fileInfo;
}

@end

@implementation CommonQGBaseDecoder
...
- (CommonQGBaseDFileInfo *)fileInfo {
