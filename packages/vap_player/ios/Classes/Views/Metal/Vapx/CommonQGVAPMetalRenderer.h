...
@interface CommonQGVAPMetalRenderer : NSObject
...
- (void)renderPixelBuffer:(CVPixelBufferRef)pixelBuffer metalLayer:(id)layer mergeInfos:(NSArray<CommonQGVAPMergedInfo *> *)infos;
- (void)dispose;
