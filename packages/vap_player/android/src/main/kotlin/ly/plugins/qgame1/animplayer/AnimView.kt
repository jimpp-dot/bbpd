...
import ly.plugins.qgame1.animplayer.file.AssetsFileContainer
import ly.plugins.qgame1.animplayer.file.FileContainer
...
import ly.plugins.qgame1.animplayer.util.ScaleTypeUtil
import java.io.File

class AnimView constructor(surfaceTexture: SurfaceTexture, textureId: Int):
    IAnimView,
    ...
    init {
        ...
        hide()
        player = AnimPlayer(this, textureId)
