...
typedef AudioRecordFrameCallback = Function(Uint8List samples, int numOfSamples,
...
class RtcEngineEventHandler {
  ...
  AudioRecordFrameCallback? audioRecordFrame;
  ...
  void process(String methodName, List<dynamic> data) {
    switch (methodName) {
      ...
      case 'UploadLogResult':
        ...
        break;
      case 'AudioRecordFrame':
        audioRecordFrame?.call(data[0], data[1], data[2], data[3], data[4]);
        break;
    }
  }
}
