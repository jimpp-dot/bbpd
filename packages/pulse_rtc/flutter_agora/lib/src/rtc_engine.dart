...
class RtcEngine with RtcEngineInterface {
  ...
  @override
   Future<bool> setBeauty(bool enableBeauty) async {
    bool res  = await _invokeMethod('setBeauty', {'enableBeauty': enableBeauty});
    return res;
  }
  ...
  Future<void> setRecordingAudioFrameParameters(
    ...
    return _invokeMethod('setRecordingAudioFrameParameters', {
  ...
  /// common add
  @override
  Future<void> registerAudioFrameObserver() {
    return _invokeMethod('registerAudioFrameObserver');
  }

  /// common add
  @override
  Future<void> unregisterAudioFrameObserver() {
    return _invokeMethod('unregisterAudioFrameObserver');
  }

  /// common add
  @override
  Future<void> enableCustomCaptureRender(bool enabled) {
    return _invokeMethod('enableCustomCaptureRender', {
      'enabled': enabled,
    });
  }
  ...
  Future<void> startCustomCapture() {
    return _invokeMethod('startCustomCapture');
  }

  /// common add
  @override
  Future<void> stopCustomCapture() {
    return _invokeMethod('stopCustomCapture');
  }
}
...
mixin RtcVideoInterface {
  ...
  //是否开启美颜Source设置
  Future<bool> setBeauty(bool flag);
