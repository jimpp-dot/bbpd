...
import 'enums.dart' as em;

part 'agora_enum_converter.g.dart';
...
@JsonSerializable()
class AreaCodeConverter extends EnumConverter<em.AreaCode, int> {
  AreaCodeConverter(em.AreaCode e) : super(e);
...
@JsonSerializable()
class AudioLocalErrorConverter extends EnumConverter<LocalAudioStreamError, int> {
  AudioLocalErrorConverter(LocalAudioStreamError e) : super(e);
...
@JsonSerializable()
class AudioLocalStateConverter extends EnumConverter<LocalAudioStreamState, int> {
  AudioLocalStateConverter(LocalAudioStreamState e) : super(e);
...
@JsonSerializable()
class AudioMixingReasonConverter extends EnumConverter<AudioMixingReasonType, int> {
  AudioMixingReasonConverter(AudioMixingReasonType e) : super(e);
...
class AudioMixingStateCodeConverter
    extends EnumConverter<AudioMixingStateType, int> {
  AudioMixingStateCodeConverter(AudioMixingStateType e) : super(e);
...
class ConnectionChangedReasonConverter
    extends EnumConverter<ConnectionChangedReasonType, int> {
  ConnectionChangedReasonConverter(ConnectionChangedReasonType e) : super(e);
...
//
@JsonSerializable()
class ErrorCodeConverter extends EnumConverter<ErrorCodeType, int> {
  ErrorCodeConverter(ErrorCodeType e) : super(e);
...
@JsonSerializable()
class UserOfflineReasonConverter extends EnumConverter<UserOfflineReasonType, int> {
  UserOfflineReasonConverter(UserOfflineReasonType e) : super(e);
...
@JsonSerializable()
class WarningCodeConverter extends EnumConverter<WarnCodeType, int> {
  WarningCodeConverter(WarnCodeType e) : super(e);
...
@JsonSerializable()
class WarningCodeConverter2 extends EnumConverter<em.WarningCode, int> {
  WarningCodeConverter2(em.WarningCode e) : super(e);

  WarningCodeConverter2.fromValue(int value)
      : super.fromValue(_$WarningCodeEnumMap2, value);

  int value() {
    return super.toValue(_$WarningCodeEnumMap2);
  }
}
...
@JsonSerializable()
class PreloadStatusCodeConverter
    extends EnumConverter<PreloadStatusCode, int> {
