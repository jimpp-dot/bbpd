...
final class VideoPlayer {
  ...
  private void initCache(Context context) {
    ...
    File cacheFolder = new File(context.getCacheDir(), "video_cache");
    // Specify cache size and removing policies
    // My cache size will be 100MB and it will automatically remove least recently used files if the size is reached out.
    LeastRecentlyUsedCacheEvictor cacheEvictor = new LeastRecentlyUsedCacheEvictor(100 * 1024 * 1024);
    // Build cache
    cache = new SimpleCache(cacheFolder, cacheEvictor, databaseProvider);
  }
